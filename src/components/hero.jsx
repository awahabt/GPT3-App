...
const hero = () => {
  return (
    <div className=" flex-wrap w-[100%] min-[1386px]:flex min-[1386px]:justify-between max-[1386px]:justify-around ">
      <div className="fontmanrop mt-16 max-[1386px]:w-[100%] max-[1386px]:text-center min-[1386px]:w-[600px] max-[1386px]:items-center">
        ...
        <div className="w-[100%] mt-8 max-[601px]:flex-wrap max-[601px]:flex-column input-div"><form className="flex">
          <input
            className="input"
            type="email"
