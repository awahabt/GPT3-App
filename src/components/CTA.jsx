...
const CTA = () => {
  return (
    <div className="flex flex-wrap my-[100px] gap-10 bg-gradients items-center rounded-xl justify-between CTA fontmanrop max-[1080px]:justify-center max-[1080px]:mx-[4%]">
